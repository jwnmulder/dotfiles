...
if (-not (Get-Module -FullyQualifiedName @{ModuleName="PackageManagement";ModuleVersion="1.4.8"})) {
...
if (-not (Get-Module -FullyQualifiedName @{ModuleName="PowerShellGet";ModuleVersion="2.0"})) {
...
# PSScriptAnalyzer
if (-not (Get-Module -FullyQualifiedName @{ModuleName="PSScriptAnalyzer";ModuleVersion="2.0"})) {
...
if (-not (Get-Module -FullyQualifiedName @{ModuleName="PSReadLine";ModuleVersion="2.2.6"})) {
